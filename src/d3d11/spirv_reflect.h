...
using SpvStorageClass = spv::StorageClass;
using SpvBuiltIn = spv::BuiltIn;
using SpvDim = spv::Dim;
using SpvImageFormat = spv::ImageFormat;
using SpvOp = spv::Op;
using SpvExecutionModel = spv::ExecutionModel;
using SpvSourceLanguage = spv::SourceLanguage;
